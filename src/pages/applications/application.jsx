        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2 mt-4">
            {job.type === "Virtual Interview" ? (
              <>
                <button className="w-full bg-blue-500 text-white text-sm py-2 rounded-md">Ready to join</button>
                <button className="w-full bg-yellow-400 text-white text-sm py-2 rounded-md">Link to join</button>
