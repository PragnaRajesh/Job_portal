...
const VirtualInterview = () => {
  ...
  <button className="w-full bg-blue-500 text-white text-xs py-2 rounded-md">
    Ready to join
  </button>
  <button className="w-full bg-yellow-400 text-white text-xs py-2 rounded-md">
    Link to join
  </button>
  <button
    onClick={() => setShowReasonDropdown(!showReasonDropdown)}
    className="w-full bg-sky-400 text-white text-xs py-2 rounded-md"
  >
    Reschedule
  </button>
</div>
