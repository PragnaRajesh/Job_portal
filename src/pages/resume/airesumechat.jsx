      ...
      <div className="flex">
        <div className="w-1/3 bg-gray-50 p-6">
          <div className="text-center mb-6">
            <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden relative group">
  ...
  const getCreativeBurstLayout = (data, templateColor) => (
    <div className="bg-gradient-to-br from-pink-50 to-orange-50 overflow-hidden relative">
      ...
      <div className="relative z-10 p-8">
        <div className="text-center mb-8">
          <div className="w-32 h-32 rounded-full mx-auto mb-4 overflow-hidden relative group">
            {data.personalInfo.profilePhoto ? (
              <img
                src={data.personalInfo.profilePhoto}
                alt={data.personalInfo.name}
              ...
              <div className={`w-full h-full bg-gradient-to-r ${templateColor} flex items-center justify-center`}>
