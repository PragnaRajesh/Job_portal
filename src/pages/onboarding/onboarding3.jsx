  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col relative overflow-hidden">
      ...
      <div className="px-6 pt-12 pb-8 relative z-20">
        <div className="bg-gradient-to-br from-[#7B9EFF] to-[#A8C5FF] rounded-3xl p-6 mx-2 shadow-lg border border-[#CB9D73]/20">
      ...
      <div className="absolute top-32 left-0 right-0 bottom-20 flex items-center justify-center z-10">
        <img
          ...
          className="w-[90vw] h-auto max-h-[65vh] object-contain"
        />
      </div>
