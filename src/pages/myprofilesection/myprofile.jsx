...
const MyProfile = () => {
  ...
  return (
     <div className="min-h-screen bg-gray-100 font-sans">
      {/* Profile Header Card */}
      <div className="relative rounded-b-3xl p-4 pt-2 text-white overflow-hidden mb-4" style={{ background: 'none', minHeight: '11.25rem' }}>
      ...
      <div style={{ height: 'calc(env(safe-area-inset-bottom) + 4.5rem)' }}></div>
